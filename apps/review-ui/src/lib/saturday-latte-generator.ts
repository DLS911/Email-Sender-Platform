...
- **coverDetail**: A SECOND SCENIC/LOCATION SHOT from THIS cover story's destination — a different angle or subject than the hero, but still a real scene the reader wants to be in. Think of it as a companion hero: another vista, another named landmark, another feature of the place. NOT a tight object still-life. NOT a doorknob / window latch / bare mailbox close-up. Austin's rule: "dude just do another location shot."

**IF THE COVER STORY HAS A SIGNATURE SUBJECT — put it in the frame.** When the story is about wildlife (whales, birds, elk, brown bears), a festival (Guelaguetza dancers, Fasnacht parades), an activity (kayakers on a fjord, surfers at a specific point break, cyclists on a mountain pass), or a specific piece of infrastructure (a train crossing a viaduct, a boat leaving a harbor at dawn), the coverDetail MUST feature that subject in scene. A whale-watching cover story WITHOUT a whale image is a miss — one of the two images must show whales (or their scale cue: a spout on the water, a fluke breaking the surface, a boat with a whale-shaped silhouette off the bow). A Guelaguetza cover story needs dancers in traje in the frame somewhere across the two location shots. A surfing cover story needs a surfer or a wave.

**Rules for the two location shots (hero + coverDetail together):**
- They must FRAME THE PLACE TWO DIFFERENT WAYS. If hero is a wide vista of the town, coverDetail can be the harbor / a signature landmark / the wildlife / the festival scene. If hero is the wildlife, coverDetail can be the town / the coastline / a landmark. Two different aspects, both scenic.
- Neither can be a tight object still-life. Neither can be a doorknob / window latch / bare mailbox. Both must feel like "I want to be there."
- People rule (same as hero): 0-2 human figures max, incidental scale references, never a crowd unless the crowd IS the story (Guelaguetza, Semana Santa procession, Nadaam festival opening).

**BANNED coverDetail defaults (all read as generic AI output):** "a street food stand," "a food stall," "a morning market scene," "a market crowd," "a downtown crowd," "a night market," "a busy street," "a bustling plaza," "a doorknob," "a window latch," "a mailbox," "a chair against a wall," "a shop sign at dusk with no scene." If your instinct is one of these, ZOOM OUT — pick a scenic shot of the actual destination with a specific landmark, geographic feature, or the story's signature subject in frame.

Examples that work:
- Kaikōura whale-watching story: hero = wide coastline with Seaward Kaikōura Range behind, coverDetail = a sperm whale fluke rising over the water with a boat 200m off, backlit by afternoon sun.
- Oaxaca Guelaguetza story: hero = a wide plaza view of Santo Domingo at dusk with lantern light, coverDetail = a delegation of dancers in Tehuana traje mid-procession on a cobblestone lane, brass band behind them.
- Piran Slovenia story: hero = the Venetian bell tower over red-tile roofs from the marina, coverDetail = the empty amphitheater square (Tartinijev trg) at 7am with wet cobblestone reflections.
