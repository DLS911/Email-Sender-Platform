...
- **coverDetail**: MUST reference a specific ONE-thing detail from THIS cover story's location AND that detail must be VISUALLY CAPTIVATING — the reader stops scrolling. Not a generic version of that kind of detail, and not a boring object either. Example: "The interior of the Commonweal Theatre lobby in Lanesboro at 6pm — brass wall sconces, playbill stack on a walnut table, one folded program left on a leather bench." Not "a small-town theater lobby." **BANNED coverDetail defaults (all read as generic AI output):** "a street food stand," "a food stall," "a morning market scene," "a market crowd," "a downtown crowd," "a night market," "a busy street," "a bustling plaza." Cover Detail is a TIGHT editorial still-life OR a single named architectural / interior / object detail — never a busy generic scene. If you're tempted to write "a street food stand at [destination]'s morning market," STOP and pick instead a single named element: a specific storefront the writer knows exists ("Nakabashi Bridge's red arch in the snow"), a single interior element of a named place ("the copper hood over the tempura counter at Kajibashi Honten"), or a specific still-life ("a rack of drying hoba leaves at a specific miso maker"). Detail = ONE object OR one architectural piece OR one interior at one named spot — never a scene with people milling around a generic food-vendor cliché.

**COVERDETAIL CAPTIVATION RULE — the frame must EARN attention.** A "window with a frosty latch" is a real detail but it's not captivating — same reason no one would frame a doorknob as art. The coverDetail must have EITHER: (a) rich visual texture the reader wants to reach out and touch (weathered brass, wet cobblestone in raking light, worn leather grain, fresh-cut oysters on ice, steam curling off a pot, a wall of colored spice jars, a plate of jamón being sliced, the copper interior of a still, molten glass being blown, a fire pit at dusk, layered wax candle drippings on old wood, a soaked wool blanket on a cedar bench in a bathhouse), (b) unusual light/color that stops the eye (Northern-lights green on snow, gold-hour light through an amber whisky glass, cobalt Portuguese tiles catching afternoon sun, saffron threads on white marble), OR (c) something quietly happening (a butcher trimming, a baker turning dough, a fisherman at dawn tying knots, an old radiator hissing steam next to a book left open, wax being sealed on a bottle). Static objects on plain surfaces are only OK if they have compelling texture — a bare metal window latch on white paint is not compelling.
Fail-cases (write it differently): "a wooden door with iron hinges," "a window with condensation," "an empty chair against a wall," "a shop sign at dusk with no other elements," "a doorknob," "a mailbox," "an empty street corner sign." If your instinct is one of these, ADD what's happening around it and what the eye lands on (steam from a nearby vent hitting the door, a bowl of oysters on ice next to the mailbox, the light spilling out of the shop as a figure inside is silhouetted at the counter).
