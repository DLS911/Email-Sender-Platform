...
- **Pour-over kettle specific (gooseneck kettles, Fellow Stagg, Hario Buono, etc.):** these have a closed lid and a narrow gooseneck spout. When actively pouring, steam comes FROM THE STREAM as it hits the coffee bed in the filter (that's the "bloom"), and can rise faintly from the spout tip. Steam does NOT plume from the top of the closed lid. If the kettle is off-heat sitting on the counter next to a V60, there should be minimal or no visible steam at all — a still-life kettle image is not a physics puzzle; it's a still object.
